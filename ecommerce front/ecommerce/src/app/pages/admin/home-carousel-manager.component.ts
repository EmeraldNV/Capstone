...
@Component({
  selector: 'app-home-carousel-manager',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './home-carousel-manager.component.html',
  styleUrl: './home-carousel-manager.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HomeCarouselManagerComponent implements AfterViewInit, OnChanges, OnDestroy {
  @Input() images: HomeCarouselImageResponse[] = [];
  ...
  protected orderedImages: HomeCarouselImageResponse[] = [];
